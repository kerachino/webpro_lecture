...
$site_top = "http://myrtilles.starfree.jp/char_school_submit";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "myrtilles.hh@hotmail.com";
...
<br /><br /><input type="button" value=" 戻るボタン!! " onClick="history.back()">
</div>
</body>
</html>
<?php }else{ ?>
送信ありがとうございました。<br />
送信は正常に完了しました。<br /><br />
<a href="<?php echo $site_top ;?>" class="btn">トップページへ戻る&raquo;</a>
</div>
